...
public class Data
{
    ...
    private static List<Question> questions = new List<Question>
    {
        ...
        new Question(6, "6. What is the first thing you do when your in a Wizard's Duel?"),
    ...
    private static List<Answer> answers = new List<Answer>
    {
        ...
        new Answer(10, 3, "You're curious about the lessons, so you start by going to the library.", new Dictionary<string, int> { {"Gryffindor", 1}, {"Hufflepuff", 0}, {"Ravenclaw", 3}, {"Slytherin", -1} }),
