...
public class Data
{
    ...
    private static List<Question> questions = new List<Question>
    {
        ...
        new Question(7, "7. You see that Frank is getting bullied by Devin, because Frank's parents are not wizzard. What do you do?"),
        new Question(8, "8. You're competeting in the Triwizard Tournament. In the first stage you need to obtain an egg of one of these dragons, which one would it be?"),
